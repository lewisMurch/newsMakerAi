...
command = f'cmd /c "{bat_file_path}" --/exts/omni.services.transport.server.http/port=8012'
    ...
    for domain_num in range (0, domain_amount):
        ...
        for article_num in range(0, article_amount): 
            try:
                ...
                try:
                    print(f'Error with generating article number {article_num} in left: ', e)
                except:
                    print('Error with generating article left: ', e)
